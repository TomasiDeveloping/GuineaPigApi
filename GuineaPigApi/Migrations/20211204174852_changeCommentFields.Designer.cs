...
namespace GuineaPigApi.Migrations
{
    ...
    [Migration("20211204174852_changeCommentFields")]
    partial class changeCommentFields
    {
            ...
            modelBuilder.Entity("GuineaPigApi.Models.HealthCheck", b =>
                {
                    ...
                    b.Property<DateTime>("HealthCheckDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 4, 18, 48, 51, 887, DateTimeKind.Local).AddTicks(3985));
